...
if __name__ == '__main__':
    ...
    for seed in seeds:
        ...
        envs = [Game.MAZECOINLOWMAPS.value]
        #agents = [Experiment.AGENT_HEQHP.value]
        agents = [Experiment.AGENT_SS.value]
        ...
        for a in agents:
            for e in envs:
                ...
                experiment_manager.learn(use_function_set_random_seed=True, render=render, save_image_level=True, show_hud=show_hud)
        ...
        for a in agents:
            for e in envs:
                experiment_manager = ExperimentManager(learning_rate = learning_rate, 
                                                    ...
                                                    n_epochs=n_epochs, batch_size=batch_size,
                                                    policy_kwargs = policy_kwargs, uuid = uuid, seed = seed)
                experiment_manager.inference(time_steps=600, use_function_set_random_seed=True, seeds=[seed], render=render, record_video=record_video, show_hud=True)