...
class MiniMapLowMapsEnv(BasePCGRLEnv):
    ...
    def __init__(self, seed = None, show_logger = False, save_logger = False, save_image_level = False, path = "", rep = None, action_change = False, piece_size = 8, board = (3,2), callback = BasePCGRLCallback()):        
        ...
        super(MiniMapLowMapsEnv, self).__init__(seed = seed, game = game, save_image_level = save_image_level, save_logger = save_logger, show_logger=show_logger, rep=rep, piece_size = piece_size, board = board, path=path, callback=callback)
    ...
    def create_action_space(self):
        ...
        path_piece = os.path.join(PCGRLPUZZLE_MAP_PATH, "minimap-lowmodels/")
